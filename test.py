...
if not os.path.exists(args.dicom_dir):  os.makedirs(args.dicom_dir)
if not os.path.exists(args.vols_dir):  os.makedirs(args.vols_dir)
if not os.path.exists(args.cands_dir):  os.makedirs(args.cands_dir)
if not os.path.exists(args.slices_dir):  os.makedirs(args.slices_dir)
if not os.path.exists(args.sorted_slices_dir):  os.makedirs(args.sorted_slices_dir)
if not os.path.exists(args.sorted_slices_jpgs_dir):  os.makedirs(args.sorted_slices_jpgs_dir)
